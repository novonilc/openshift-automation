...
projects_str = subprocess.check_output(["oc", "get","--no-headers", "projects", "|egrep -v ecomm|scm"])
projects = projects_str.split("\n")

#excludes = ["default","openshift","openshift-infra","logging","kube-public","kube-system","sysdig-cloud"]
excludes = ["default","openshift","kube-public","kube-system","sysdig-cloud","ecomm-","scm","ec-acc-","ansible","awx"]
...
for project in projects:
    ...
    if (not namespace.startswith("corp-")):
        continue
